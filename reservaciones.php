<?php 
   ...
   $miConsulta = $miPDO->prepare('SELECT * FROM reservas;');
   $miConsulta->execute();
...
<section style = "padding: 10px; background:white;">
 ...
 <div class="form-group" style ="padding:10px;">
  <a href ="formulario_reservaciones.php" class="btn btn-default" style="background:black; color:white;">Nueva reserva</a>
 </div>
 ...
 <div class="table-responsive">
  <table class="table table-bordered" style="background:black; color:white;  border-color:white; border-radius: 30px;">
    ...
    <tr>
       ...
       <td>
       <?php
        echo"<a href='modificar_reserva.php?search=$a' class=btn btn-default style=  background:green;color:white;>Modificar</a>";
       ?>
      </td>
      <td>
       <?php
        echo"<a href='pdf_reservas.php?pdfr=$a' class=btn btn-default style=background:#8BC34A; color:white;>PDF</a>";
       ?>
      </td>
       </td>
